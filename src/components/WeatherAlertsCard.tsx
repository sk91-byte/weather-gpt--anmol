        ...
        <div className="flex items-center space-x-2">
          {onOpenWhatsAppAlerts && (
            <button
              ...
              className="text-[11px] font-bold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200/80 px-2 py-0.5 rounded-full transition cursor-pointer flex items-center gap-1 shadow-2xs"
              title="Configure automated WhatsApp alerts"
            >
              <span>📱</span>
