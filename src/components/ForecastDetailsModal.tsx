...
import { X, Calendar, Clock, CloudRain, Thermometer, Wind, Droplets, Sun, ChevronRight, Cpu } from './Icons';
        ...
        <div className="p-5 space-y-4 overflow-y-auto">
          ...
          {onOpenNWP && (
            <button
              ...
              className="w-full p-2.5 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl flex items-center justify-between text-left hover:border-blue-400 transition cursor-pointer group"
            >
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  <div className="text-xs font-extrabold text-blue-950 flex items-center space-x-1.5">
                    <span>Compare NWP Models</span>
                    <span className="text-[9px] px-1.5 py-0.2 bg-blue-600 text-white rounded-full font-bold">
                      GFS • WRF • ECMWF
                    </span>
                  </div>
                  <span className="text-[10px] text-blue-700">Multi-model atmospheric physics & divergence</span>
                </div>
              </div>
