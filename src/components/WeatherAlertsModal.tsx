  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in duration-200">
      ...
      >
        ...
        {/* WhatsApp Alerts Callout Banner */}
        {onOpenWhatsAppAlerts && (
          <div className="mx-4 mt-3 p-3 bg-gradient-to-r from-emerald-500/10 via-teal-500/10 to-emerald-500/5 border border-emerald-200 rounded-2xl flex items-center justify-between shadow-2xs">
            <div className="flex items-center space-x-2.5">
              <span className="text-xl">📱</span>
              <div>
                <h4 className="text-xs font-bold text-emerald-950">Twilio WhatsApp Early Warnings</h4>
                <p className="text-[10px] text-emerald-700">Get automatic alerts on WhatsApp for cloudbursts & floods</p>
              </div>
            </div>
            <button
              onClick={() => {
              ...
              className="px-2.5 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs rounded-xl transition cursor-pointer shadow-xs whitespace-nowrap ml-2"
            >
              Configure
            </button>
          </div>
