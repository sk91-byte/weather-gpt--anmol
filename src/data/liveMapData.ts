...
export const NEARBY_SAFE_PLACES: NearbySafePlace[] = [
  {
    ...
    coords: { x: 28, y: 28, lat: 28.5250, lng: 77.1490 },
  ...
  },
  {
    ...
    distanceMeters: 420,
    walkingMinutes: 5,
    address: 'Courtyard Galleria, Ground Level',
    coords: { x: 30, y: 25, lat: 28.5265, lng: 77.1540 },
    openStatus: 'Open • Indoor AC & Power Outlets',
    shelterFeature: 'Spacious dry seating lounge, hot beverages',
  ...
  },
  {
    ...
    coords: { x: 32, y: 32, lat: 28.5210, lng: 77.1530 },
  ...
  },
  {
    ...
    category: 'restaurant',
    categoryLabel: 'North Indian Restaurant',
    rating: 4.5,
    reviews: 630,
    distanceMeters: 480,
    walkingMinutes: 6,
    address: 'Ambience Boulevard, Block A',
    coords: { x: 35, y: 30, lat: 28.5225, lng: 77.1465 },
    openStatus: 'Open • Family Dining',
    shelterFeature: 'Covered canopy entrance, complimentary warm chai',
    phone: '+91 124 4001122'
  },
  {
    ...
    coords: { x: 24, y: 22, lat: 28.5295, lng: 77.1480 },
    openStatus: 'Open 24/7',
    shelterFeature: 'Dry entryway shelter, umbrellas, hot snacks',
    phone: '+91 124 4567890'
  },
  {
    id: 'reliance-fresh',
    name: 'Smart Point Superstore',
    category: 'convenience',
    categoryLabel: 'Department Store & Pharmacy',
    rating: 4.3,
    reviews: 215,
    distanceMeters: 380,
    walkingMinutes: 5,
    address: 'Community Center Plaza, Gate 1',
    coords: { x: 22, y: 26, lat: 28.5270, lng: 77.1440 },
    openStatus: 'Open till 11 PM',
    shelterFeature: 'Wide covered shopping arcade & ATM shelter',
    phone: '+91 11 2612 8899'
  },
  {
    id: 'hp-petrol',
    ...
    coords: { x: 22, y: 36, lat: 28.5190, lng: 77.1410 },
    openStatus: 'Open 24/7',
  ...
  {
    id: 'indian-oil-pump',
    name: 'Indian Oil Swagat Fuel Stop',
    category: 'petrol',
    categoryLabel: 'Petrol & EV Quick Charger',
    rating: 4.4,
    reviews: 280,
    distanceMeters: 650,
    walkingMinutes: 8,
    address: 'Mehrauli-Gurgaon Road, Sector 28',
    coords: { x: 25, y: 38, lat: 28.5175, lng: 77.1470 },
    openStatus: 'Open 24/7 • EV Fast Charger',
    shelterFeature: 'Massive dry fuelling canopy with convenience kiosk',
    phone: '+91 124 2389900'
  },
  {
    id: 'fortis-emergency',
    name: 'City Care Medical & Pharmacy',
    category: 'hospital',
    categoryLabel: '24/7 Clinic & Emergency',
    rating: 4.9,
    reviews: 840,
    distanceMeters: 750,
    walkingMinutes: 10,
    address: 'Sector Health Hub, Gate 2',
    coords: { x: 18, y: 30, lat: 28.5160, lng: 77.1570 },
  ...
  },
  {
    ...
    category: 'hospital',
    categoryLabel: 'Hospital & Urgent Care',
    rating: 4.8,
    reviews: 950,
    distanceMeters: 890,
    walkingMinutes: 11,
    address: 'Aruna Asaf Ali Marg, Pocket 1',
    coords: { x: 16, y: 32, lat: 28.5200, lng: 77.1620 },
    openStatus: '24/7 Emergency & Pharmacy',
    shelterFeature: 'Covered ambulance bay, 24-hr air-conditioned reception',
  ...
  },
  {
    ...
    category: 'hotel',
    categoryLabel: 'Hotel & Premium Lounge',
    rating: 4.7,
    reviews: 620,
    distanceMeters: 600,
    walkingMinutes: 8,
    address: 'Asset Area 4, Aerocity Corridor',
    coords: { x: 36, y: 20, lat: 28.5350, lng: 77.1420 },
  ...
  {
    id: 'taj-city-hotel',
    name: 'Taj Vivanta Lobby Cafe',
    category: 'hotel',
    categoryLabel: '5-Star Hotel & Tea Lounge',
    rating: 4.8,
    reviews: 780,
    distanceMeters: 720,
    walkingMinutes: 9,
    address: 'Sector 44 Commercial Complex',
    coords: { x: 38, y: 24, lat: 28.5320, lng: 77.1380 },
    openStatus: 'Open 24/7',
    shelterFeature: 'Indoor porch drive-through, executive lounge',
    phone: '+91 124 6671234'
  }
];
